...
// let num1 = Number(prompt('Введите сторону квадрата'))
// alert('Площадь квадрата равна' + num1 ** 2)
...
// let num1 = Number(prompt('Введите ширину прямоугольника'))
// let num2 = Number(prompt('Введите высоту прямоугольника'))
// alert('Периметр прямоугольника равна' + (num1 + num2) * 2)
